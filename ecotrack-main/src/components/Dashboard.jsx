  ...
  return (
    <div className="p-6 min-h-screen bg-gray-50">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h3 className="text-xl font-semibold mb-4 text-center">Your Carbon Emission History</h3>
        {data.length > 0 ? (
          ...
          <p className="text-center text-gray-500">No emission data available yet.</p>
        )}
      </div>
    </div>
  );
