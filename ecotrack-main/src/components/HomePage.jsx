        ...
        <div className="min-h-screen flex flex-col justify-center px-4 sm:px-8 md:px-20 items-center bg-gradient-to-b from-green-100 to-white">
            <div className='flex flex-col md:flex-row justify-between items-center gap-10 w-full max-w-7xl'>
                <div className="flex-1 ml-12 mt-5 ">
                    <TypingText text="Track Your Impact on the Planet 🌍" speed={200} pause={2000} />
                    ...
                    <a href="#about" className="px-6 py-3 bg-white text-green-500 font-semibold rounded-full border-2 border-green-500 hover:bg-green-50 transition-colors duration-200 block w-max mx-auto md:ml-0">
                        Learn More
                    </a>
                </div>
            ...
            <section id="about" className="py-16 bg-white rounded-3xl mt-36 w-full max-w-7xl shadow-lg mb-16 px-4">
